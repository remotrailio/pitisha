        ...
        <form wire:submit="saveProfile" class="space-y-4">
            <div>
                ...
                <input wire:model="name" id="name" type="text" required
                       class="mt-1 block w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 hover:border-slate-300 transition-all duration-150">
