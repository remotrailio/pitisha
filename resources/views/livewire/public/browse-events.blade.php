            ...
            <div class="min-w-0 flex-1">
                ...
                <div class="mb-5 flex items-center justify-between lg:hidden">
                    <button @click="filtersOpen = true"
                        class="inline-flex items-center gap-2 border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:border-blue-300 hover:bg-blue-50 transition-all">
                    ...
                    <select wire:model.live="sort"
                        class="border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20">
