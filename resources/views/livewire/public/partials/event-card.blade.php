...
<a href="{{ $eventUrl }}" class="group flex flex-col overflow-hidden border border-gray-200 bg-white cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-gray-200/60">
    <div class="relative aspect-square overflow-hidden">
        ...
        @else
            <div class="flex h-full w-full items-center justify-center bg-linear-to-br from-teal-50 to-teal-100">
                <svg class="h-12 w-12 text-teal-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if ($showFeatured)
            <span class="absolute left-3 top-3 rounded-full bg-teal-600 px-2.5 py-1 text-xs font-semibold text-white shadow-sm">
                Featured
            </span>
        @endif
