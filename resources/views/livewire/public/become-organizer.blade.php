        ...
        <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
                <div class="rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                    <div class="p-5">
                        <div class="text-xs font-semibold tracking-widest uppercase mb-1.5 text-gray-400">Fill More Seats</div>
                        <h3 class="text-base font-semibold text-gray-900 mb-1">Reach Thousands of Attendees</h3>
                        <p class="text-sm text-gray-500">Connect with engaged audiences across Kenya. Your events get discovered by buyers actively looking for what you offer.</p>
                    </div>
                                                            ...
                                                            <div class="absolute inset-0 p-5 flex flex-col gap-3.5">
                                                                <div class="flex items-start justify-between">
                                                                    <div>
                                                                        ...
                                                                        <div class="text-sm mt-0.5"
                                                                            style="color: #6b7280;">Sat, Aug 12 · Uhuru
                                                                ...
                                                                <div class="rounded-xl p-4 "
                                                                    ...
                                                                    <div class="flex justify-between mt-2"><span class="text-xs"
                                                                            style="color: #6b7280;">82.6% sold</span><span
                                                                ...
                                                                <div class="flex items-center gap-3">
                                                                    <div class="flex">
                                                                        ...
                                                                        style="color: #6b7280;">attending this
                                                                        event</span>
                                                                </div>
                                                                <div class="flex flex-col gap-2 mt-auto">
                                                                    <div class="flex items-center gap-2.5 px-3 py-2 rounded-xl"
                                                                        ...
                                                                        <span style="font-size: 14px;">🎫</span><span class="flex-1 text-xs"
                                                                            ...
                                                                            VIP tickets</span><span class="text-xs"
                                                                            style="color: #9ca3af;">just now</span></div>
                                                                    <div class="flex items-center gap-2.5 px-3 py-2 rounded-xl"
                                                                        style="background: #f0faf9; border: 1px solid #d1fae5;">
                                                                        <span style="font-size: 14px;">📤</span><span class="flex-1 text-xs"
                                                                            style="color: #111827;">Shared 340 times
                                                                            today</span><span class="text-xs"
                                                                            style="color: #9ca3af;">live</span></div>
                                                                    <div class="flex items-center gap-2.5 px-3 py-2 rounded-xl"
                                                                        style="background: #f0faf9; border: 1px solid #d1fae5;">
                                                                        <span style="font-size: 14px;">📍</span><span class="flex-1 text-xs"
                                                                            style="color: #111827;">Trending #1 in Music —
                                                                            Nairobi</span><span class="text-xs"
                                                                            style="color: #9ca3af;">1h ago</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                </div>
                <div class="rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                    <div class="p-5">
                        <div class="text-xs font-semibold tracking-widest uppercase mb-1.5 text-gray-400">Get Paid Faster</div>
                        <h3 class="text-base font-semibold text-gray-900 mb-1">Secure & Fast Payments</h3>
                        <p class="text-sm text-gray-500">Reliable payouts with M-Pesa, card, and more. Track every transaction and get paid on your schedule.</p>
                    </div>
                    <div class="relative overflow-hidden rounded-xl mx-3 mb-3"
                                                            style="aspect-ratio: 16 / 10; background: #ffffff; border: 1px solid #e6f7f5; box-shadow: 0 2px 16px rgba(16,91,85,0.10), 0 1px 4px rgba(0,0,0,0.06);">
                                                            <div class="absolute"
                                                            ...
                                                            <div class="absolute inset-0 p-5 flex flex-col gap-3.5">
                                                                <div class="flex items-start justify-between">
                                                                    <div>
                                                                        ...
                                                                        <div class="flex items-center gap-2 mt-1.5"><span
                                                                                ...
                                                                                +23%</span><span class="text-xs"
                                                                                style="color: #6b7280;">vs.
                                                                                yesterday</span></div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="text-xs mb-1.5"
                                                                            style="color: #6b7280;">This Week</div>
                                                                ...
                                                                <div class="rounded-xl p-4 flex-1"
                                                                    ...
                                                                    <div class="text-xs font-semibold mb-3"
                                                                        style="color: #6b7280;">Recent Payments</div>
                                                                    <div class="flex flex-col gap-2.5">
                                                                        ...
                                                                        <div class="flex items-center gap-3">
                                                                            ...
                                                                            <div class="flex-1 min-w-0">
                                                                                ...
                                                                                <div class="text-xs"
                                                                                    style="color: #6b7280;">Card</div>
                                                                            </div>
                                                                            <div class="text-right">
                                                                                <div class="text-gray-900 text-xs font-semibold">KES 3,000
                                                                                </div>
                                                                                <div class="text-xs"
                                                                                    style="color: #9ca3af;">5m ago</div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="flex items-center gap-3">
                                                                            <div class="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0"
                                                                        ...
                                                                        <div class="flex items-center gap-3">
                                                                            ...
                                                                            <div class="text-right">
                                                                                ...
                                                                                <div class="text-xs"
                                                                                    style="color: #9ca3af;">12m ago</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                <div class="rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                    <div class="p-5">
                        <div class="text-xs font-semibold tracking-widest uppercase mb-1.5 text-gray-400">Understand Your Audience</div>
                        <h3 class="text-base font-semibold text-gray-900 mb-1">Grow With Real Insights</h3>
                        <p class="text-sm text-gray-500">Real-time analytics on who is buying, when, and where — so you can make smarter decisions every event.</p>
                    </div>
                    <div class="relative overflow-hidden rounded-xl mx-3 mb-3"
                                                            style="aspect-ratio: 16 / 10; background: #ffffff; border: 1px solid #e6f7f5; box-shadow: 0 2px 16px rgba(16,91,85,0.10), 0 1px 4px rgba(0,0,0,0.06);">
                                                            <div class="absolute"
                                                            ...
                                                            <div class="absolute inset-0 p-5 flex flex-col gap-3.5">
                                                                <div class="flex items-start justify-between">
                                                                    <div>
                                                                        ...
                                                                        <div class="text-xs mt-0.5"
                                                                            style="color: #6b7280;">Last 12 weeks</div>
                                                                    </div><span
                                                                        class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-semibold"
                                                                ...
                                                                <div class="rounded-xl p-3 "
                                                                    ...
                                                                    <svg viewBox="0 0 300 54" width="100%" height="54">
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="none" stroke="#1a7a72" stroke-width="2"
                                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                                        <circle cx="300" cy="10" r="4" fill="#1a7a72"
                                                                ...
                                                                <div class="grid grid-cols-3 gap-2.5">
                                                                    <div class="rounded-xl p-3 text-center"
                                                                        ...
                                                                        <div class="text-xs mt-0.5"
                                                                            style="color: #6b7280;">45% of buyers</div>
                                                                    </div>
                                                                    <div class="rounded-xl p-3 text-center"
                                                                        style="background: #f0faf9; border: 1px solid #d1fae5;">
                                                                        <div class="text-xs mb-1" style="color: #6b7280;">
                                                                        ...
                                                                        <div class="text-xs mt-0.5"
                                                                            style="color: #6b7280;">71% local</div>
                                                                    </div>
                                                                    <div class="rounded-xl p-3 text-center"
                                                                        style="background: #f0faf9; border: 1px solid #d1fae5;">
                                                                        <div class="text-xs mb-1" style="color: #6b7280;">
                                                                        ...
                                                                        <div class="text-xs mt-0.5"
                                                                            style="color: #6b7280;">Sat &amp; Sun</div>
                                                                    </div>
                                                                </div>
                                                                <div class="rounded-xl p-4 flex-1"
                                                                    style="background: #f0faf9; border: 1px solid #d1fae5;">
                                                                    <div class="text-xs font-semibold mb-3"
                                                                        style="color: #6b7280;">Traffic Sources</div>
                                                                    <div class="flex flex-col gap-2.5">
                                                                        <div class="flex items-center gap-3">
                                                                            <div class="text-xs flex-shrink-0"
                                                                                style="color: #374151; width: 76px;">
                                                                                Instagram</div>
                                                                            ...
                                                                            <div class="text-xs text-right"
                                                                                style="color: #4b5563; width: 28px;">42%
                                                                            </div>
                                                                        </div>
                                                                        <div class="flex items-center gap-3">
                                                                            <div class="text-xs flex-shrink-0"
                                                                            ...
                                                                            <div class="text-xs text-right"
                                                                                style="color: #4b5563; width: 28px;">28%
                                                                            </div>
                                                                        </div>
                                                                        <div class="flex items-center gap-3">
                                                                            <div class="text-xs flex-shrink-0"
                                                                            ...
                                                                            <div class="text-xs text-right"
                                                                                style="color: #4b5563; width: 28px;">18%
                                                                            </div>
                                                                        </div>
                                                                        <div class="flex items-center gap-3">
                                                                            <div class="text-xs flex-shrink-0"
                                                                            ...
                                                                            <div class="text-xs text-right"
                                                                                style="color: #4b5563; width: 28px;">12%
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                <div class="rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                    <div class="p-5">
                        <div class="text-xs font-semibold tracking-widest uppercase mb-1.5 text-gray-400">Keep Fake Tickets Out</div>
                        <h3 class="text-base font-semibold text-gray-900 mb-1">Built-In Fraud Protection</h3>
                        <p class="text-sm text-gray-500">QR-code check-in and ticket verification stop counterfeits at the door and protect your revenue.</p>
                    </div>
                    <div class="relative overflow-hidden rounded-xl mx-3 mb-3" style="aspect-ratio: 16 / 10; background: #ffffff; border: 1px solid #e6f7f5; box-shadow: 0 2px 16px rgba(16,91,85,0.10), 0 1px 4px rgba(0,0,0,0.06);">
                        <div class="absolute" style="width: 220px; height: 220px; border-radius: 50%; background: rgb(34, 197, 94); opacity: 0.06; filter: blur(70px); top: -60px; right: -60px;"></div>
                        <div class="absolute inset-0 p-5 flex gap-4">
                            {{-- QR code SVG --}}
                            <div class="flex flex-col items-center justify-center gap-3 shrink-0" style="width: 140px;">
                                <div style="background-color: white; padding: 6px; border-radius: 10px; box-shadow: 0 2px 12px rgba(0,0,0,0.10);">
                                    <svg width="100" height="100" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!-- top-right finder -->
                                        <rect x="13" y="1" width="7" height="7" rx="1" fill="#0f172a"/>
                                        <rect x="14" y="2" width="5" height="5" rx="0.5" fill="white"/>
                                        <rect x="15" y="3" width="3" height="3" fill="#0f172a"/>
                                        <!-- bottom-left finder -->
                                        <rect x="1" y="13" width="7" height="7" rx="1" fill="#0f172a"/>
                                ...
                                <div class="flex items-center gap-1.5 px-2.5 py-1 rounded-full" style="background: rgba(34, 197, 94, 0.12); border: 1px solid rgba(34, 197, 94, 0.35);">
                            ...
                            <div class="flex flex-col gap-2.5 flex-1">
                                <div>
                                    <div class="text-xs font-semibold tracking-widest uppercase mb-1" style="color: #6b7280;">Live Check-In</div>
                                    ...
                                    <div class="w-full h-2 rounded-full mt-1.5" style="background: #e5e7eb;">
                                        <div class="h-2 rounded-full" style="width: 84.7%; background: linear-gradient(90deg, rgb(22, 163, 74), rgb(74, 222, 128));"></div>
                                    </div>
                                    <div class="text-xs mt-1" style="color: #6b7280;">84.7% checked in</div>
                                </div>
                                <div class="grid grid-cols-2 gap-1.5">
                                    <div class="rounded-xl p-2.5" style="background: #f0faf9; border: 1px solid #d1fae5;">
                                ...
                                <div class="rounded-xl p-2.5 flex-1" style="background: #f0faf9; border: 1px solid #d1fae5;">
                                    <div class="text-xs font-semibold mb-1.5" style="color: #6b7280;">Recent Check-ins</div>
                                    <div class="flex flex-col gap-1">
                                        @foreach ([['KN', 'rgb(124,58,237)', 'Ngugi K.'], ['AM', 'rgb(8,145,178)', 'Aisha M.'], ['TO', 'rgb(5,150,105)', 'Tom O.']] as $ci)
                                            <div class="flex items-center gap-2">
                                                <div style="width:20px;height:20px;border-radius:50%;background:{{ $ci[1] }};display:flex;align-items:center;justify-content:center;font-size:8px;font-weight:700;color:white;flex-shrink:0;">{{ $ci[0] }}</div>
                                                <span class="text-xs" style="color: #374151;">{{ $ci[2] }}</span>
                ...
                <div class="rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                    <div class="p-5">
                        <div class="text-xs font-semibold tracking-widest uppercase mb-1.5 text-gray-400">We're Here When You Need Us</div>
                        <h3 class="text-base font-semibold text-gray-900 mb-1">24/7 Dedicated Support</h3>
                        <p class="text-sm text-gray-500">Our team is always on standby to help you and your attendees — before, during, and after the event.</p>
                    </div>
                    <div class="relative overflow-hidden rounded-xl mx-3 mb-3"
                                                            style="aspect-ratio: 16 / 10; background: #ffffff; border: 1px solid #e6f7f5; box-shadow: 0 2px 16px rgba(16,91,85,0.10), 0 1px 4px rgba(0,0,0,0.06);">
                                                            <div class="absolute"
                                                                ...
                                                                <div class="flex flex-col gap-3" style="width: 160px;">
                                                                    ...
                                                                    <div class="rounded-xl p-4 "
                                                                        ...
                                                                        <div class="flex items-baseline gap-1.5"><span
                                                                                class="text-gray-900 font-bold text-2xl">4.9</span><span
                                                                                class="text-xs"
                                                                    ...
                                                                    <div class="rounded-xl p-3 "
                                                                        ...
                                                                        <div class="text-xs mt-1.5"
                                                                            style="color: #6b7280;">3 agents ready</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                    <div class="p-5">
                        <div class="text-xs font-semibold tracking-widest uppercase mb-1.5 text-gray-400">Launch in Minutes</div>
                        <h3 class="text-base font-semibold text-gray-900 mb-1">Effortless Event Setup</h3>
                        <p class="text-sm text-gray-500">Create, configure tickets, and publish your event in minutes. No technical knowledge required.</p>
                    </div>
                    <div class="relative overflow-hidden rounded-xl mx-3 mb-3"
                                                            style="aspect-ratio: 16 / 10; background: #ffffff; border: 1px solid #e6f7f5; box-shadow: 0 2px 16px rgba(16,91,85,0.10), 0 1px 4px rgba(0,0,0,0.06);">
                                                            <div class="absolute"
                                                                    ...
                                                                    <div class="flex items-center">
                                                                        ...
                                                                        <div class="flex items-center">
                                                                            <div class="w-8 h-px mx-2"
                                                                                style="background: rgb(74, 222, 128);"></div>
                                                                            <div class="flex items-center gap-1.5">
                                                                                <div class="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold"
                                                                                    style="background: rgb(34, 197, 94); color: white;">✓
                                                                                </div><span class="text-xs font-medium"
                                                                ...
                                                                <div class="flex flex-col gap-3" style="width: 168px;">
                                                                    <div class="flex items-center gap-2.5 p-3 rounded-xl"
                                                                        ...
                                                                        <div>
                                                                            <div class="text-xs font-bold"
                                                                                style="color: #16a34a;">Event is LIVE!</div>
                                                                            <div class="text-xs" style="color: #6b7280;">
                                                                                Sales open now</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="rounded-xl p-3 flex-1"
                                                                        ...
                                                                        <div class="text-gray-900 text-xs font-bold leading-tight">Nairobi Jazz
                                                                            Festival</div>
                                                                        <div class="text-xs mt-0.5"
                                                                            style="color: #6b7280;">Aug 12 · Uhuru Park
                                                                        </div>
